  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="flex justify-center mt-4 flex-col items-center">
        <h1 className="text-gray-900 font-bold font-serif text-3xl">Name</h1>
        <h1 className="text-gray-900 font-bold font-serif text-2lx">Bio</h1>
      </div>
      ...
      {/* <div className="px-10">
        ...
        <div className="flex justify-center overflow-x-auto gap-8 w-5/6 mx-auto">
          <Card name="Hiking" />
          <Card name="Book Club" />
          <Card name="Biking" />
          <Card name="Car Meet" />
      ...
      <div className="grid grid-cols-3 gap-6 w-5/6 mx-auto px-6">
        {["Dance Party", "Run Club", "Chess Tournament"].map((label, i) => (
          <div
            key={i}
      ...
      <div className="w-5/6 px-6 mx-auto">
        <div className="bg-black  w-full h-[1px] my-12 mx-auto"></div>
      </div>
